...
<head>
    ...
    <link rel="stylesheet" href="/webapp/static/adminlte/plugins/iCheck/square/blue.css">
...
<script src="/webapp/static/adminlte/plugins/iCheck/icheck.min.js"></script>
<script src="/webapp/static/js/login.1.js"></script>
