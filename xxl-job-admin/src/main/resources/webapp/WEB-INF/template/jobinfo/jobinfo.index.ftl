...
<script src="${request.contextPath}/webapp/static/plugins/jquery/jquery.validate.min.js"></script>
<!-- moment -->
<script src="${request.contextPath}/webapp/static/adminlte/plugins/daterangepicker/moment.min.js"></script>
<script src="${request.contextPath}/webapp/static/js/jobinfo.index.1.js"></script>
</body>
</html>
