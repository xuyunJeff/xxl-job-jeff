...
<head>
	...
	<!-- DataTables -->
  	<link rel="stylesheet" href="${request.contextPath}/webapp/static/adminlte/plugins/datatables/dataTables.bootstrap.css">
  	<!-- daterangepicker -->
  	<link rel="stylesheet" href="${request.contextPath}/webapp/static/adminlte/plugins/daterangepicker/daterangepicker.css">
...
<!-- DataTables -->
<script src="${request.contextPath}/webapp/static/adminlte/plugins/datatables/jquery.dataTables.min.js"></script>
<script src="${request.contextPath}/webapp/static/adminlte/plugins/datatables/dataTables.bootstrap.min.js"></script>
<!-- daterangepicker -->
<script src="${request.contextPath}/webapp/static/adminlte/plugins/daterangepicker/moment.min.js"></script>
<script src="${request.contextPath}/webapp/static/adminlte/plugins/daterangepicker/daterangepicker.js"></script>
<script src="${request.contextPath}/webapp/static/js/joblog.index.1.js"></script>
</body>
</html>
