...
<#-- echarts -->
<script src="${request.contextPath}/webapp/static/plugins/echarts/echarts.common.min.js"></script>
<script src="${request.contextPath}/webapp/static/js/index.js"></script>
</body>
</html>
